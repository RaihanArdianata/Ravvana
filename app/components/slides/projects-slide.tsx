...
const PROJECTS: Project[] = [
  {
    ...
    demo: 'https://hardhat-studio.nawasena-labs.com/',
  ...
  },
  {
    id: 3,
    name: 'PayID SDK',
    type: 'Developer Tool · SDK',
    year: '2025',
    status: 'live',
    statusLabel: 'Live',
    desc: 'A programmable, policy-driven payment SDK for autonomous AI agents and dApps. Enables deterministic off-chain rule execution via a WASM sandbox, EIP-712 decision proofs, and secure on-chain verification.',
    stack: ['TypeScript', 'Solidity', 'WASM', '0G Storage', 'EIP-712', 'Viem'],
    demo: 'https://docs.payid.nawasena-labs.com/',
    demoLabel: 'docs.payid.nawasena-labs.com',
  ...
  },
  {
    ...
    status: 'live',
    statusLabel: 'Live',
    desc: 'A fintech dashboard and developer console for the PayID ecosystem. Features modular policy creation, social login onboarding, privacy-first stealth addresses, and real-time gasless claim flows.',
    stack: ['Next.js', 'React', 'TypeScript', 'Tailwind', 'Zustand', 'Framer Motion'],
    demo: 'https://app.payid.nawasena-labs.com/',
    demoLabel: 'app.payid.nawasena-labs.com',
    repo: 'https://github.com/Mad1Duck/payid',
    repoLabel: 'github.com/Mad1Duck/payid',
  },
  {
    ...
    demo: 'https://hono-decorator.nawasena-labs.com/',
  ...
  {
    id: 8,
    name: 'Scholarship Protocol',
    type: 'Web3 · Education',
    year: '2026',
    status: 'live',
    statusLabel: 'Live',
    desc: 'A decentralized scholarship platform where communities govern educational funding on-chain. Donors contribute to a pool and gain proportional voting rights to select applicants. Funds are locked in escrow and released incrementally as recipients complete milestones — not upfront. Disputes over milestone completion go to a commit-reveal arbiter panel to prevent collusion. Contributions earn commemorative NFTs as proof of participation.',
    stack: ['Solidity', 'React', 'TypeScript', 'Hono', 'Ponder', 'wagmi', 'Lisk'],
    demo: 'https://skoolcein.nawasena-labs.com/',
    demoLabel: 'skoolcein.nawasena-labs.com',
    repo: 'https://github.com/Cunguk-Kids/scholarship',
    repoLabel: 'github.com/Cunguk-Kids/scholarship',
  },
  {
    id: 7,
